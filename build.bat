...
set "cppflags=/O2 /W4 /EHsc /D_CRT_SECURE_NO_WARNINGS /Fo:build/ /Fe:build/ /Fd:build/"
...
cl %cppflags% .\build\glad.obj .\src\main.cpp .\src\asset_load\*.cpp .\src\shader\*.cpp .\src\texture\*.cpp .\src\window\*.cpp .\src\event\*.cpp .\src\editor\*.cpp %tp_includes% /link .\thirdparty\freetype\lib\freetype.lib .\thirdparty\SDL2\lib\SDL2.lib /out:editor.exe